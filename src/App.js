...
const App = () => {
  ...
  return (
    <div>
      ...
      <div ref={printRef} style={{ invisible: false }}>
        <div>
          Hi <span>{content.name}</span>
        </div>
        <div>
          Your email is sent to<span>{content.email}</span>
        </div>
        <img
        ...
        />
        <div>
          The subject of the email is<span>{content.subject}</span>
        </div>
        <div>
          The main message is <span>{content.message}</span>
        </div>
      </div>
    </div>
  );
